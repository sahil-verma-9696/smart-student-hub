          ...
          <Table>
            ...
            <TableBody>
              {students.map((student) => {
                // Chooses nested basicUserDetails or flat student fields
                ...
                return (
                  <TableRow key={student._id || student.id}>
                    ...
                    <TableCell>
                      {userDetails?.contactInfo?.phone || (
                        <span className="text-muted-foreground">—</span>
                      )}
                    </TableCell>

                    <TableCell>
                      {userDetails?.contactInfo?.alternatePhone || (
                        <span className="text-muted-foreground">—</span>
                      )}
                    </TableCell>

                    <TableCell>
                      {userDetails?.contactInfo?.address || (
                        <span className="text-muted-foreground">—</span>
                      )}
                    </TableCell>
