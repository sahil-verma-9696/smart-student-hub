...
import { Search, Eye, Download, Calendar, Clock, CheckCircle, AlertCircle, Hourglass } from "lucide-react"
...
const mockActivities = [
  {
    ...
    status: "approved",
    points: 10,
    description: "Comprehensive 3-day workshop on ML fundamentals and applications",
  ...
  },
  {
    ...
    status: "pending",
    points: 25,
    description: "48-hour coding hackathon focused on sustainable technology solutions",
  ...
  },
  {
    ...
    status: "approved",
    points: 5,
    description: "Volunteered at college blood donation drive, helped with registration",
  ...
  },
  {
    ...
    status: "pending",
    points: 30,
    description: "Published research paper on machine learning applications in medical diagnosis",
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Track and manage all your submitted activities</CardDescription>
      </CardHeader>
      <CardContent>
        {/* Filters */}
